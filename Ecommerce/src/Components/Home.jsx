  ...
  return (
    <main className="flex flex-col h-auto w-screen items-center py-12 bg-gray-100  ">
      <div className="flex flex-col  h-[auto] w-screen py-4 px-5">
        <p className="text-[4.7vh] font-sans font-bold text-gray-800 ">
          Welcome
        </p>
        <p className="text-[2.7vh] font-bold text-gray-500 ">
          back{" "}
      ...
      <div className="flex items-center rounded-[1vh] mt-2 bg-gray-200 px-3 py-1 w-[90%] border-2 border-gray-300">
        ...
        <input
          className="text-gray-700 outline-none bg-transparent rounded-[1vh]  py-1 px-3"
          placeholder="Search..."
        />
      </div>
      ...
      <p className="text-[3.5vh] my-3 font-bold text-gray-700">
        Top Collections
      </p>
